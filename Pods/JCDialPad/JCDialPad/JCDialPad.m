...
- (void)initializeProperties
{
    ...
    [self.deleteButton setTitleColor:[[UIColor blackColor] colorWithAlphaComponent:0.500] forState:UIControlStateNormal];
    [self.deleteButton setTitleColor:[[UIColor grayColor] colorWithAlphaComponent:0.500] forState:UIControlStateHighlighted];
...
- (void)layoutButtons
{
    ...
    CGFloat verticalButtonPadding         = MIN(10, maxTotalPaddingHeight / (numRows-1));
